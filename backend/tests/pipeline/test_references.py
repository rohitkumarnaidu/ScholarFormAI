...
class TestReferenceParser:
    ...
    def test_process_empty_document(self, parser):
        ...
        doc = PipelineDocument(
            document_id="t", blocks=[Block(block_id="b1", index=1, text="hello", block_type=BlockType.BODY)]
        )
...
class TestReferenceFormatterEngine:
    ...
    def test_format_all_with_csl_fallback(self, formatter):
        ...
        refs = [
            Reference(
                reference_id="r1", citation_key="k1", raw_text="Test", index=1, authors=["A"], title="T", year=2024
            )
        ]
    ...
    def test_format_single(self, formatter):
        ...
        ref = Reference(
            reference_id="r2", citation_key="k2", raw_text="Test", index=1, authors=["A. B."], title="Title", year=2024
        )
