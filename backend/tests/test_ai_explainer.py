...
class TestExplainResults:
    ...
    def test_missing_section_error(self):
        ...
        explainer = AIExplainer()
        result = explainer.explain_results({"errors": ["Missing required section: Methods"]}, publisher="IEEE")
        assert len(result) == 1
    ...
    def test_reference_error(self):
        ...
        explainer = AIExplainer()
        result = explainer.explain_results({"errors": ["Reference 'Smith2020' missing authors"]})
        assert len(result) == 1
    ...
    def test_general_error(self):
        ...
        explainer = AIExplainer()
        result = explainer.explain_results({"errors": ["Some random formatting issue"]})
        assert len(result) == 1
    ...
    def test_different_publisher(self):
        ...
        explainer = AIExplainer()
        result = explainer.explain_results({"errors": ["Missing required section: Methods"]}, publisher="APA")
