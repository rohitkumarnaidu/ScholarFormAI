...
- Ensure the project adheres to its [Governance Model](GOVERNANCE.md) and [Release Strategy](RELEASE.md).
...
2. **Review:** The steering committee (currently the Core Maintainers) reviews the contributor's history (code, issue triage, community support).
