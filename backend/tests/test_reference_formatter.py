...
class TestFormatReference:
    ...
    def test_citeproc_path(self):
        ...
        with patch("app.pipeline.formatting.reference_formatter.CITEPROC_AVAILABLE", True), \
             ...
             patch("app.pipeline.formatting.reference_formatter.CitationStylesBibliography", FakeCiteProc.CitationStylesBibliography), \
    ...
    def test_citeproc_exception_falls_back(self):
        ...
        with patch("app.pipeline.formatting.reference_formatter.CITEPROC_AVAILABLE", True), \
             ...
             patch("app.pipeline.formatting.reference_formatter.CitationStylesStyle", side_effect=Exception("bad style")):
    ...
    def test_style_cache_miss_and_fail(self):
        ...
        with patch("app.pipeline.formatting.reference_formatter.CitationStylesStyle", side_effect=Exception("load error")):
            formatter = ReferenceFormatter(loader)
