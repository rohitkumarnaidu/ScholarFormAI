    ...
    doc = PipelineDocument(
        ...
        blocks=[
            ...
            Block(
                block_id="b2",
                index=1,
                text="This is body text with smart quotes \u201cHello\u201d.",
        ...
        doc = PipelineDocument(
            ...
            blocks=[
                Block(
                    block_id="b1",
                    index=0,
                    text="Abstract: This paper presents a novel method.",
                    block_type=BlockType.UNKNOWN,
                ),
            ],
        )
        ...
        doc = PipelineDocument(
            ...
            blocks=[
                Block(
                    block_id="b1",
                    index=0,
                    text="Abstract \u2014 The system achieves high accuracy.",
                    block_type=BlockType.UNKNOWN,
                ),
            ],
        )
        ...
        doc = PipelineDocument(
            ...
            blocks=[
                Block(
                    block_id="b1",
                    index=0,
                    text="1 IntroductionThis section introduces the topic and background.",
                    block_type=BlockType.UNKNOWN,
                ),
            ],
        )
        ...
        doc = PipelineDocument(
            ...
            blocks=[
                Block(
                    block_id="b1",
                    index=0,
                    text="IntroductionThis section provides background on the topic and reviews related work in the field.",
                    block_type=BlockType.UNKNOWN,
                ),
            ],
        )
...
class TestFigureBlockPreservation:
    ...
    def test_empty_figure_block_kept(self, normalizer):
        ...
        doc = PipelineDocument(
            document_id="fig2",
            blocks=[
                Block(block_id="b1", index=0, text="", block_type=BlockType.UNKNOWN, metadata={"has_figure": True}),
            ],
        )
        result = normalizer.process(doc)
        assert len(result.blocks) == 1
...
class TestEmptyOrphanSanitization:
    ...
    def test_empty_with_figure_kept(self, normalizer):
        ...
        doc = PipelineDocument(
            document_id="eo3",
            blocks=[
                Block(block_id="b1", index=0, text="", block_type=BlockType.BODY, metadata={"has_figure": True}),
            ],
        )
        result = normalizer._sanitize_empty_orphan_blocks(doc.blocks)
        assert len(result) == 1
    ...
    def test_empty_with_equation_kept(self, normalizer):
        ...
        doc = PipelineDocument(
            document_id="eo4",
            blocks=[
                Block(block_id="b1", index=0, text="", block_type=BlockType.BODY, metadata={"has_equation": True}),
            ],
        )
        result = normalizer._sanitize_empty_orphan_blocks(doc.blocks)
        assert len(result) == 1
    ...
    def test_empty_with_list_level_kept(self, normalizer):
        ...
        doc = PipelineDocument(
            document_id="eo5",
            blocks=[
                Block(block_id="b1", index=0, text="", block_type=BlockType.BODY, metadata={"list_level": 1}),
            ],
        )
        result = normalizer._sanitize_empty_orphan_blocks(doc.blocks)
        assert len(result) == 1
