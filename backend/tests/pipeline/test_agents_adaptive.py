...
class TestAdaptiveStrategyAdapt:
    ...
    def test_adapt_low_success_rate_increases_retries(self):
        ...
        tracker = MagicMock()
        tracker.get_summary.return_value = {"agent": {"success_rate": 0.5, "avg_duration": 30, "fallback_rate": 0}}
        strategy = AdaptiveStrategy(tracker)
    ...
    def test_adapt_high_success_rate_decreases_retries(self):
        ...
        tracker = MagicMock()
        tracker.get_summary.return_value = {"agent": {"success_rate": 0.99, "avg_duration": 30, "fallback_rate": 0}}
        strategy = AdaptiveStrategy(tracker)
        initial = strategy.config["max_retries"]
        strategy.adapt()
    ...
    def test_adapt_timeout_based_on_duration(self):
        ...
        tracker = MagicMock()
        tracker.get_summary.return_value = {"agent": {"success_rate": 0.8, "avg_duration": 100, "fallback_rate": 0}}
        strategy = AdaptiveStrategy(tracker)
        strategy.adapt()
    ...
    def test_adapt_high_fallback_rate_increases_threshold(self):
        ...
        tracker = MagicMock()
        tracker.get_summary.return_value = {"agent": {"success_rate": 0.8, "avg_duration": 30, "fallback_rate": 0.5}}
        strategy = AdaptiveStrategy(tracker)
    ...
    def test_adapt_low_fallback_rate_decreases_threshold(self):
        ...
        tracker = MagicMock()
        tracker.get_summary.return_value = {"agent": {"success_rate": 0.8, "avg_duration": 30, "fallback_rate": 0.0}}
        strategy = AdaptiveStrategy(tracker)
        initial = strategy.config["fallback_threshold"]
        strategy.adapt()
        assert strategy.config["fallback_threshold"] < initial
    ...
    def test_adapt_retries_clamped_to_max(self):
        ...
        tracker = MagicMock()
        tracker.get_summary.return_value = {"agent": {"success_rate": 0.0, "avg_duration": 30, "fallback_rate": 0}}
        strategy = AdaptiveStrategy(tracker)
    ...
    def test_adapt_fallback_clamped_to_max(self):
        ...
        tracker = MagicMock()
        tracker.get_summary.return_value = {"agent": {"success_rate": 0.8, "avg_duration": 30, "fallback_rate": 0.9}}
        strategy = AdaptiveStrategy(tracker)
    ...
    def test_adapt_timeout_clamped_to_min(self):
        ...
        tracker = MagicMock()
        tracker.get_summary.return_value = {"agent": {"success_rate": 0.8, "avg_duration": 1, "fallback_rate": 0}}
        strategy = AdaptiveStrategy(tracker)
        strategy.adapt()
    ...
    def test_adapt_timeout_clamped_to_max(self):
        ...
        tracker = MagicMock()
        tracker.get_summary.return_value = {"agent": {"success_rate": 0.8, "avg_duration": 500, "fallback_rate": 0}}
        strategy = AdaptiveStrategy(tracker)
        strategy.adapt()
