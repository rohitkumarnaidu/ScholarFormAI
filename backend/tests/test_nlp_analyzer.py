...
class TestEvaluateCaptionQuality:
    def test_good_caption(self):
        ...
        analyzer = ContentAnalyzer()
        result = analyzer._evaluate_caption_quality("Figure 1: The experimental results show significant improvement")
        assert result == "Good"
...
class TestCheckReadability:
    def test_standard(self):
        ...
        result = analyzer._check_readability(
            "This is a standard length sentence with enough words. So is this nice paragraph of average length."
        )
...
class TestProcess:
    ...
    def test_readability_check_on_abstract(self):
        ...
        doc.blocks = [
            Block(
                block_id="b1",
                text="This paper background and results show clear evidence",
                index=0,
