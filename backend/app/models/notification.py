...
class Notification(Base):
    ...
    )  # system, ai, security, performance, update, maintenance, incident, deployment, usage, billing
    ...
    retry_count = Column(
        String, default="0"
    )  # Using string temporarily if integer is tricky, wait no, let's just use string to be safe on sqlite vs postgres differences or Integer
