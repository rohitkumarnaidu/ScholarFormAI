...
class TestTemplateIntegration:
    ...
    def test_dynamic_content_insertion(self):
        ...
        context = {
            ...
            "sections": [{"heading": "Introduction", "content": "..."}, {"heading": "Methods", "content": "..."}],
        }
    ...
    def test_table_insertion(self):
        ...
        table_data = {
            ...
            "rows": [["Method A", "95%", "2.3s"], ["Method B", "92%", "1.8s"]],
        }
    ...
    def test_figure_insertion(self):
        ...
        # Mock figure data
        figure_data = {"caption": "Figure 1: Results", "path": "path/to/image.png", "width": 400, "height": 300}
