...
import { CheckCircle, FileText, Contact, Briefcase, ClipboardList, GraduationCap } from 'lucide-react';

const DOC_TYPES = [
    { id: 'academic_paper', label: 'Academic Paper', icon: FileText, description: 'Research paper with abstract, methodology, results, and references.', color: 'from-blue-500 to-blue-700' },
    { id: 'resume', label: 'Resume / CV', icon: Contact, description: 'Professional CV with education, experience, and skills sections.', color: 'from-emerald-500 to-emerald-700' },
    { id: 'portfolio', label: 'Portfolio', icon: Briefcase, description: 'Researcher or creative portfolio with projects and publications.', color: 'from-purple-500 to-purple-700' },
    { id: 'report', label: 'Technical Report', icon: ClipboardList, description: 'Structured technical or business report with findings and recommendations.', color: 'from-orange-500 to-orange-700' },
    { id: 'thesis', label: 'Thesis Chapter', icon: GraduationCap, description: 'Thesis or dissertation chapter with structured academic sections.', color: 'from-rose-500 to-rose-700' },
];
