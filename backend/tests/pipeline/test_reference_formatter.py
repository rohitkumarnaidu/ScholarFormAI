...
class TestReferenceTypeToCsl:
    def test_journal_article(self):
        ...
        ref = Reference(
            reference_id="r1", citation_key="k", raw_text="t", index=1, reference_type=ReferenceType.JOURNAL_ARTICLE
        )
    ...
    def test_book(self):
        ...
        ref = Reference(reference_id="r1", citation_key="k", raw_text="t", index=1, reference_type=ReferenceType.BOOK)
    ...
    def test_unknown_type(self):
        ...
        ref = Reference(
            reference_id="r1", citation_key="k", raw_text="t", index=1, reference_type=ReferenceType.UNKNOWN
        )
