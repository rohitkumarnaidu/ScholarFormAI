...
class TestMultiDocumentLearner:
    ...
    def test_record_document(self, tmp_path):
        ...
        metrics = {"duration_seconds": 30, "references_count": 25, "figures_count": 5, "success": True}
    ...
    def test_get_similar_documents(self, tmp_path):
        ...
        for i in range(3):
            learner.record_document(f"doc_{i}", {"authors": ["Author A"], "venue": "Conference X"}, {"success": True})

        # Find similar
        similar = learner.get_similar_documents({"authors": ["Author A"], "venue": "Conference X"}, limit=2)
...
class TestCustomTools:
    ...
    def test_register_tool(self):
        ...
        tool_class = register_custom_tool(
            name="test_tool", description="Test tool", input_schema={"text": (str, "Input text")}, execute_fn=my_fn
        )
    ...
    def test_citation_formatter(self):
        ...
        result = tool._run(authors=["Smith, J.", "Doe, A."], title="Test Paper", year="2024", style="apa")
    ...
    def test_keyword_extractor(self):
        ...
        result = tool._run(
            text="machine learning artificial intelligence neural networks deep learning", max_keywords=3
        )
