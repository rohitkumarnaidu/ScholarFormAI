...
class TestBlock:
    ...
    def test_block_with_all_fields(self):
        ...
        b = Block(
            block_id="b1", text="Item", index=0,
            block_type=BlockType.LIST_ITEM, page_number=3,
            level=1, parent_id="parent1",
            list_type=ListType.ORDERED, list_level=0,
            section_name="Methods", semantic_intent="METHODS_BODY",
            classification_confidence=0.95,
            contains_citation=True, citation_keys=["Smith2020"],
            is_valid=False, warnings=["Too short"],
            metadata={"source": "pdf"},
        )
