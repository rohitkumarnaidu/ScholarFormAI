...
class TestExportPipeline:
    ...
    def document(self):
        doc = PipelineDocument(
            ...
            metadata=DocumentMetadata(
                title="Test Title", authors=["Author One"], publication_date="2023-01-01", volume="42", issue="1"
            ),
        )
    ...
    def test_exporter_pdf_call(self, document):
        ...
        exporter.pdf_exporter.convert_to_pdf.assert_called_with("output/test.docx", "output")
