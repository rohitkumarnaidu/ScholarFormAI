...
class TestSupabaseClient:
    ...
    def test_init_client_create_client_none(self):
        with patch(f"{self.MODULE}.settings") as mock_settings, patch(f"{self.MODULE}.create_client", None):
    ...
    def test_init_client_success(self):
        ...
        with patch(f"{self.MODULE}.settings") as mock_settings, patch(f"{self.MODULE}.create_client") as mock_create:
            mock_settings.SUPABASE_URL = "https://project.supabase.co"
            mock_settings.SUPABASE_SERVICE_ROLE_KEY = "service-key"
