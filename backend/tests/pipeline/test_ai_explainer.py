...
class TestAIExplainer:
    def test_explain_string_errors(self):
        ...
        results = e.explain_results(
            {"errors": ["missing section: references", "bad reference format"]}, publisher="IEEE"
        )
    ...
    def test_explain_unknown_string_category(self):
        ...
        e = AIExplainer()
        results = e.explain_results({"errors": ["something unknown happened"]})
    ...
    def test_explain_unknown_dict_category(self):
        ...
        e = AIExplainer()
        results = e.explain_results({"errors": [{"category": "unknown_type", "message": "Something broke"}]})
        assert len(results) == 1
        assert "formatting error" in results[0]
    ...
    def test_publisher_is_used(self):
        ...
        e = AIExplainer()
        results = e.explain_results({"errors": ["missing section: conclusion"]}, publisher="ACM")
