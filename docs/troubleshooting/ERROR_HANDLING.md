...
- [Testing Architecture](../architecture/TESTING_ARCHITECTURE.md) — test coverage for error paths
...
- [Security Architecture](../architecture/SECURITY_ARCHITECTURE.md) — middleware security layers
- [Configuration Reference](../reference/CONFIGURATION_REFERENCE.md) — rate limit and timeout settings
