...
class TestRunStartupStep:
    ...
    async def test_success(self):
        ...
        result = await _run_startup_step("test", lambda: "ok", timeout_seconds=5.0)
        assert result == "ok"
    ...
    async def test_timeout(self):
        ...
        result = await _run_startup_step("slow", slow_op, timeout_seconds=0.1, default_value="default")
    ...
    async def test_exception(self):
        ...
        result = await _run_startup_step("fail", failing_op, timeout_seconds=5.0, default_value="fallback")
...
class TestBuildErrorResponse:
    ...
    def test_with_details(self):
        ...
        resp = build_error_response(
            request, status_code=400, code="BAD_REQUEST", message="bad", details={"field": "err"}
        )
