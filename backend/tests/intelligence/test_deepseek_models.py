...
def run_model_comparison():
    ...
    test_blocks = [
        ...
        {
            "text": "This paper presents a novel approach to academic manuscript formatting using AI-powered semantic analysis.",
            "index": 1,
            "block_id": "b2",
        },
        {"text": "Methodology", "index": 2, "block_id": "b3"},
        {
            "text": "We employed a multi-stage pipeline consisting of extraction, classification, and formatting layers.",
            "index": 3,
            "block_id": "b4",
        },
    ]
    ...
    for model in models:
        ...
        try:
            ...
            results[model] = {"latency": 0, "success": False, "error": str(e)}
    ...
    if len(results) == 2:
        ...
        print(
            f"{'Has Semantic Types':<30} {r1.get('has_semantic_type', False)}{'':<15} {r2.get('has_semantic_type', False)}"
        )
