...
class Reference(BaseModel):
    ...
    number: int | None = Field(default=None, description="Sequential reference number (e.g., 1 for '[1]')")
    ...
    # --- Publication venue ---
    journal: str | None = Field(default=None, description="Journal name (for articles)")
    conference: str | None = Field(default=None, description="Conference name (for conference papers)")
    book_title: str | None = Field(default=None, description="Book title (for books or book chapters)")
    ...
    issn: str | None = Field(default=None, description="ISSN (for journals)")
    url: str | None = Field(default=None, description="Web URL")
    arxiv_id: str | None = Field(default=None, description="arXiv identifier (for preprints)")

    # --- Other fields ---
    edition: str | None = Field(default=None, description="Edition (for books)")
    note: str | None = Field(default=None, description="Additional notes")

    # Position in document
    block_id: str | None = Field(default=None, description="Block ID of this reference in the references section")
