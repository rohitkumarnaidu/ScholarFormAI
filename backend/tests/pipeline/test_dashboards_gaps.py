...
class TestAdvancedAnalyticsDashboard:
    ...
    def test_generate_html(self, tmp_path):
        ...
        adaptive = MagicMock()
        adaptive.get_config.return_value = {
            "max_retries": 3,
            "timeout_seconds": 30,
        ...
        d = AdvancedAnalyticsDashboard(
            ml_detector=ml, multi_doc_learner=mdoc, adaptive_strategy=adaptive, distributed_coord=dist
        )
