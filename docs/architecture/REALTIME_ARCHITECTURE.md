...
Frontend/src/lib/ReconnectingWebSocket.js exports a default class. Mock the module:
...
**Cross-reference**: See [FRONTEND_ARCHITECTURE.md Section 13.1](FRONTEND_ARCHITECTURE.md#131-content-security-policy-csp) for CSP header configuration and [docs/ENTERPRISE_CERTIFICATION.md](../reports/ENTERPRISE_CERTIFICATION.md) for security compliance details.
...
**Cross-reference**: See [Section 11.3](#113-scaling-guide) for Render-specific limits and [docs/FRONTEND_ARCHITECTURE.md Section 14.1](FRONTEND_ARCHITECTURE.md#141-vercel-deployment) for frontend deployment scalability.
...
**Cross-reference**: See [FRONTEND_ARCHITECTURE.md Section 10.1](FRONTEND_ARCHITECTURE.md#101-testing-patterns) for general frontend testing patterns, [FRONTEND_ARCHITECTURE.md Section 19.1](FRONTEND_ARCHITECTURE.md#191-mocking-conventions) for mocking conventions, and [docs/COVERAGE_GAP_REPORT.md](../../COVERAGE_GAP_REPORT.md) for the real-time testing coverage breakdown.
