...
- [prometheus.yml (docker)](../../backend/docker/prometheus/prometheus.yml)
- [prometheus.yml (ops)](../../backend/ops/prometheus/prometheus.yml)
...
- [.env.example:1-135](../../backend/.env.example#L1-L135)
...
- [logging_config.py:1-185](../../backend/app/config/logging_config.py#L1-L185)
- [prometheus.yml (docker):1-17](../../backend/docker/prometheus/prometheus.yml#L1-L17)
- [prometheus.yml (ops):1-11](../../backend/ops/prometheus/prometheus.yml#L1-L11)
...
- [.env.example:1-135](../../backend/.env.example#L1-L135)
- [settings.py:1-422](../../backend/app/config/settings.py#L1-L422)
- [docker-compose.yml:33-40](../../backend/docker/docker-compose.yml#L33-L40)
...
- [docker-compose.yml:96-100](../../backend/docker/docker-compose.yml#L96-L100)
- [deploy-production.yml:1-63](../../.github/workflows/deploy-production.yml#L1-L63)
...
- [docker-compose.yml:42-94](../../backend/docker/docker-compose.yml#L42-L94)
- [.env.example:85-105](../../backend/.env.example#L85-L105)
...
- [docker-compose.yml:15-21](../../backend/docker/docker-compose.yml#L15-L21)
- [logging_config.py:1-185](../../backend/app/config/logging_config.py#L1-L185)
- [pipeline.json:1-448](../../backend/docker/grafana/dashboards/pipeline.json#L1-L448)
